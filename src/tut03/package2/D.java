...
//		variables with scope default are only visible to classes in the same package 
//		System.out.println("var: " + objA.var);
		System.out.println("varPub: "  + objA.varPub);

//		The line below does not compile because 
//		variables with scope protected are only visible to classes in the same package or sub-classes 
