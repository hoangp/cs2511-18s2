...
// https://docs.oracle.com/javase/8/javafx/events-tutorial/keyboardexamplejava.htm#BABBIHCH
...
public final class EventHandleExample extends Application {
	...
	private static void configureBorder(final Region region) {
		region.setStyle("-fx-background-color: white;" + "-fx-border-color: black;" + "-fx-border-width: 1;"
